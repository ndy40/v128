 ...
 * @author Oliver Winks
 */
class xml_handler extends CI_Model {
...
//            WHERE n.name = '" . $metadataname_data['name'] . "' AND i.institution_name = '" . $institution_name . "'";
    ...
    private function parse_related_objects($object_xml, $object_id) {
        $related_objects = $object_xml->xpath('*');
    ...
    public function parse_xml($filename) {
